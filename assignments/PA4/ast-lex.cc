...
static yyconst flex_int32_t yy_meta[36] = {0, 1, 1, 1, 1, 1, 1, 2, 2, 1, 2, 2,
...
#define YY_INPUT(buf, result, max_size)                                      \
    if ((result = yy_fread((char *)buf, sizeof(char), max_size, ast_file)) < \
        0)                                                                   \
    ...
    yy_match:
        do {
            ...
            while (yy_chk[yy_base[yy_current_state] + yy_c] !=
                ...
                if (yy_current_state >= 163) yy_c = yy_meta[(unsigned int)yy_c];
            }
            yy_current_state =
